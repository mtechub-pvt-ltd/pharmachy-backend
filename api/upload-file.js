...
const fileFilter = (req, file, callBack) => {
    if (file.mimetype == 'application/pdf' || file.mimetype == 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' || file.mimetype == 'application/vnd.ms-powerpoint'||file.mimetype=='audio/mp3'||file.mimetype=='audio/mpeg') {
        callBack(null, true)
    } else {
        callBack(null, false)
    }
